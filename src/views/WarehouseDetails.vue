<template>
    <Layout
        page-title="Warehouse Details"
        breadcrumb-text="Manage Warehouses"
    ...
    >
        <main class="flex flex-col gap-6 flex-1">
            ...
            >
                ...
                >
                    <img
                        :src="getWarehouseImage(warehouse.photo)"
            ...
            >
                <div
                    id="Header"
                    class="flex items-center justify-between px-[18px]"
                >
                    <div class="flex flex-col gap-[6px]">
                        <p class="flex items-center gap-[6px]">
                            <span class="font-semibold text-2xl"
                                >{{ warehouseProducts.length }} Total
                                Products</span
                            >
                        </p>
                    ...
                    <router-link
                        :to="`/assign-product/${warehouse.id}`"
                ...
                <div id="Product-List" class="flex flex-col px-4 gap-5 flex-1">
                    ...
                    <div v-else class="flex flex-col gap-5">
                        <template
                            v-for="(product, index) in warehouseProducts"
                            :key="product.id"
                        >
                            <div
                            ...
                            >
                                <div
                                    class="flex items-center gap-3 w-[260px] shrink-0"
                                >
                                    <div
                                    ...
                                    <div class="flex flex-col gap-2 flex-1">
                                        <p
                                            class="font-semibold text-xl w-[162px] truncate"
                                        >
                                            {{ product.product_name }}
                                        </p>
                                        <p
                                            class="font-semibold text-xl text-monday-blue"
                                        >
                                            Rp
                                            {{
                                                formatNumber(
                                ...
                                <div
                                    class="flex items-center gap-[6px] w-[154px] shrink-0"
                                >
                                    <img
                                ...
                                <div class="flex items-center gap-4">
                                    ...
                                    <router-link
                                        :to="`/update-stock/${warehouse.id}/${product.id}`"
                            ...
                            <hr
                                v-if="index < warehouseProducts.length - 1"
                ...
                >
                    <div class="flex items-center justify-between">
                        <div class="flex flex-col gap-2">
                            <p
                                class="flex items-center gap-[6px] font-semibold text-lg"
                            >
                                <img
                                    :src="
                                        getCategoryIcon(
                            ...
                            <p
                                class="font-semibold text-[17px] text-monday-blue"
                            >
                                Rp
                                {{
    ...
    methods: {
        async loadWarehouseDetails() {
            ...
            try {
                ...
                // Support nested response shape:
                // { data: { id, ..., warehouse_products: [] }, message: "..." }
                const payload = response?.data?.data || response?.data || {};

                // Update warehouse data
                this.warehouse = payload;

                // Load warehouse products from the response
                this.warehouseProducts =
                    payload.warehouse_products ||
                    payload.warehouse_product ||
                    [];
            } catch (error) {
        ...
        getCategoryIcon(categoryName) {
            ...
            return (
                iconMap[categoryName] || "/assets/images/icons/note-2-black.svg"
            );
        },
        formatNumber(num) {
