                    ...
                    >
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            >
                                <img
                                    :src="
                                        getMerchantImage(merchantDetails.photo)
                                    "
                    ...
                    >
                        ...
                        >
                            ...
                            <select
                                ...
                                class="appearance-none w-full h-[72px] font-semibold text-lg outline-none pl-20 pr-6 pb-[14.5px] pt-[32px]"
                                :disabled="
                                    isLoadingWarehouses || !formData.productId
                                "
                            >
                                <option value="" disabled selected>
                                    {{
                        ...
                        <div class="flex items-center justify-end gap-4">
                            <router-link
                                :to="`/merchants/${$route.params.merchantId}`"
                    ...
                    <ul class="flex flex-col gap-4">
                        <li class="flex gap-[6px]">
                            ...
                            <p class="font-medium leading-[140%]">
                                Verify and confirm merchant Lorem information to
                                ensure accuracy
                            </p>
                        </li>
                        <li class="flex gap-[6px]">
                            ...
                            />
                            <p class="font-medium leading-[140%]">
                                Verify all details for accuracy before
                                proceeding to prevent errors
                            </p>
                        </li>
                        <li class="flex gap-[6px]">
                            <img
                            ...
                            />
                            <p class="font-medium leading-[140%]">
                                Accurately enter the stock quantity to maintain
                        ...
                        <li class="flex gap-[6px]">
                            ...
                            />
                            <p class="font-medium leading-[140%]">
                                Carefully review warehouse and product details
                                to ensure accuracy Ipsum
                            </p>
                        </li>
                        <li class="flex gap-[6px]">
                            <img
                            ...
                            />
                            <p class="font-medium leading-[140%]">
                                Click 'Create Now' to assign and finalize the
                                process efficiently
                            </p>
                        </li>
                    </ul>
...
export default {
    ...
    methods: {
        async loadMerchantDetails() {
            ...
            try {
                // Get merchant details (support nested and flat response shape)
                ...
                this.merchantDetails = {
                    ...
                    keeper:
                        merchantData.keeper_name || "Keeper tidak ditemukan",
        ...
        async handleSubmit() {
            ...
            try {
                ...
                const response = await assignProductToMerchant(
                    merchantId,
                    requestData,
                );
