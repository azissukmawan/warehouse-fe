  ...
  actions: {
    async fetchProducts() {
      ...
      try {
        ...
        // Gunakan ?? (nullish) bukan || agar null dari backend tidak di-fallback
        // ke response object (bukan array), yang akan menyebabkan TypeError saat .slice()
        ...
        this.products = [
          ...
          },
          {
            ...
            stock: 75,
            warehouse: 'Warehouse A',
            image: '/assets/images/thumbnails/lipstick.png',
          ...
          },
          {
            ...
            image: '/assets/images/thumbnails/smartwatch.png',
          ...
          },
          {
            ...
            image: '/assets/images/thumbnails/printer.png',
          ...
          },
          {
            ...
            stock: 25,
            warehouse: 'Warehouse B',
            image: '/assets/images/thumbnails/smartwatch-white.png',
